...
<table border="1">
 <tr nobr="true">
  <td width = "367" ><font size="1" ></font><br /><font size="1" >CompanyName</font><br /><font size="1" ></font></td>
  <td width = "23%" align = "left"><font size="2" ></font><br /><font size="1" > DATE:</font></td>
  <td width = "*"  align = "left"><font size="2" ></font><br /><font size="1" >&nbsp; $TransDate</font></td>
 </tr>
 <tr nobr="true">
  <td ALIGN="LEFT"  ><FONT SIZE=1> VAT NO   <br>
 <br>
 Tel:  &nbsp;&nbsp;
 Cell:  <br>
 <A HREF="mailto:CompanyEMailme@me.co.za">Email:  CompanyEMailme@me.co.za</A></FONT>	
		
		</td>
  <td ALIGN="LEFT"><br /><br><FONT FACE="Arial, sans-serif" size = "1"> TAX INVOICE
			NO.
	
			</FONT></td>
  <td align = "LEFT"><br><br> <FONT FACE="Arial, sans-serif" size = "2">
			$InvNo2
						</FONT>
 ...
 <tr nobr="true">
  <td align = "left"><FONT SIZE=1> Customer: 
...
<table cellspacing='0' cellpadding='0' border='1'>
 ...
 <tr style='background-color:#FFFF9F;color:#000000;'>
  ...
  <td width='6%' align='center'>Unit<br />ex VAT</td>
  <td width='*' align='center'>Total<br />ex VAT</td>
 </tr>
</thead>


 <tr nobr='true' width = '20'>
  <td width='50%' align='left'>&nbsp;$strD1</td>
  <td width='10%' align='center'>$strQ1</td>
  <td width='6%' align='right'>$Mex1&nbsp; </td>
  <td width='*' align='right'>$XT1&nbsp; </td>
 </tr>
 <tr nobr='true' width = '20'>
  <td width='50%' align='left'>&nbsp;$strD2</td>
  <td width='10%' align='center'>$strQ2</td>
   <td width='6%' align='right'>$Mex2&nbsp; </td>
      <td width='*' align='right'>$XT2&nbsp; </td>
 </tr>
  <tr nobr='true' width = '20'>
  <td width='50%' align='left'>&nbsp;$strD3</td>
  <td width='10%' align='center'>$strQ3</td>
   <td width='6%' align='right'>$Mex3&nbsp; </td>
      <td width='*' align='right'>$XT3&nbsp; </td>
 </tr>
  <tr nobr='true' width = '20'>
  <td width='50%' align='left'>&nbsp;$strD4</td>
  <td width='10%' align='center'>$strQ4</td>
   <td width='6%' align='right'>$Mex4&nbsp; </td>
      <td width='*' align='right'>$XT4&nbsp; </td>
 </tr>
  <tr nobr='true' width = '20'>
  <td width='50%' align='left'>&nbsp;$strD5</td>
  <td width='10%' align='center'>$strQ5</td>
   <td width='6%' align='right'>$Mex5&nbsp; </td>
      <td width='*' align='right'>$XT5&nbsp; </td>
 </tr>
  <tr nobr='true' width = '20'>
  <td width='50%' align='left'>&nbsp;$strD6</td>
  <td width='10%' align='center'>$strQ6</td>
   <td width='6%' align='right'>$Mex6&nbsp; </td>
      <td width='*' align='right'>$XT6&nbsp; </td>
 </tr>
  <tr nobr='true' width = '20'>
  <td width='50%' align='left'>&nbsp;$strD7</td>
  <td width='10%' align='center'>$strQ7</td>
   <td width='6%' align='right'>$Mex7&nbsp; </td>
      <td width='*' align='right'>$XT7&nbsp; </td>
 </tr>
  <tr nobr='true' width = '20'>
  <td width='50%' align='left'>&nbsp;$strD8</td>
  <td width='10%' align='center'>$strQ8</td>
   <td width='6%' align='right'>$Mex8&nbsp; </td>
      <td width='*' align='right'>$XT8&nbsp; </td>
 </tr>

 <tr nobr='true' width = '20'>
	<td width='50%' colspan = '2' align='center'></td>
   <td width='6%' align='right'>Sub-Total &nbsp;</td>
 ...
 <tr nobr='true' width = '20'>
	<td width='50%' colspan = '2' align='right'><input type='button' name='print' value='Print' onclick='print()' />
</td>
...
<BR />
Please send proof of payment to: <a href mailto: "CompanyEMailme@me.co.za">CompanyEMailme@me.co.za</a>
   ...
   <tr>
       <td align = "center">TERMS: <a href = http://TermsWebpage>CompanyWebsite/terms</a></td>
       <td  align = "center">Support: <br />
	   <a href = http://SupportWebpage>SupportWebpage</a></td>
    </tr>
