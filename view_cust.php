...
echo "<th>".$row["CustTel"]."</th>";
echo "<th>".$row["CustCell"]."</th>";
echo "<th>".$row["ADSLTel"]."</th>";
echo "<th>".$row["CustEmail"]."</th>";
echo "<th>".$row["CustAddr"]."</th>";
echo "<th>".$row["CustIDdoc"]."</th>";
echo "<th>".$row["CustDetails"]."</th>";
echo "<th>".$row["CustPW"]."</th>";
echo "<th>".$row["Distance"]."</th>";
echo "<th>".$row["Important"]."</th>";
echo "<th>".$row["ABBR"]."</th>";
echo "<th>".$row["u1"]."</th>";
echo "<th>".$row["u2"]."</th>";
//echo "<th>{$row[12]}</th>\n";
