...
echo "<h3>event of selected CustNo".$CustNo." edit_eventCQb.php</h3>";
echo "<br><a href = 'edit_eventCQM.php'> MyEdit: edit_eventCQM.php</a>";
echo "<br><a href = 'view_event.php' target=_blank> MyEdit: view_event.php ALL CUSToMERS</a>";
