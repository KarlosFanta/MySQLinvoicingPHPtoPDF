...
SELECT c.ExpNo, c.Category, c.ExpDesc, c.SerialNo, c.SupCode, c.PurchDate, c.ProdCostExVAT, c.Notes, c.CustNo , c.Category, 'expensesE' as Source
  ...
  FROM expenses a  Where CustNo = $CustInt  
UNION ALL
SELECT b.ExpNo, b.ExpDesc, b.SerialNo, b.SupCode, b.PurchDate, b.ProdCostExVAT, b.Notes, b.CustNo , b.Category, b.InvNo, 'expensesH' as Source
  FROM expensesH b   Where CustNo = $CustInt     
UNION ALL
SELECT c.ExpNo, c.ExpDesc, c.SerialNo, c.SupCode, c.PurchDate, c.ProdCostExVAT, c.Notes, c.CustNo , c.Category, c.InvNo,  'expensesE' as Source
  FROM expensesE c  Where CustNo = $CustInt    order by ExpNo desc";
...
$ExpDesc3  = '';
$ExpDesc2 = substr($row['ExpDesc'], 0, 25);
$ExpDesc3 = substr($row['ExpDesc'], 24, 50);
$ExpDesc2 = $ExpDesc2.'<br>'.$ExpDesc3;
$ExpDesc4 = substr($row['ExpDesc'], 50, 100);
if ($ExpDesc4 != '')
$ExpDesc2 = $ExpDesc2.'<br>'.$ExpDesc4;

//echo "<th>".$ExpDesc2."</th>";
echo "<th><textarea>".$row['ExpDesc']."</textarea></th>";
...
//mysqli_close($DBConnect); //wqarning! causes mysqli_query(): Couldn't fetch mysqli in other files
 ...
 $SQLstring = "SELECT a.ExpNo,  a.ExpDesc, a.SerialNo, a.SupCode, a.PurchDate,a.ProdCostExVAT, a.Notes,	a.CustNo , a.Category,a.InvNo, 'expenses' as Source
  FROM expenses a  Where CustNo = $CustInt  order by ExpNo desc";
...
if ($rowCHk == '')
echo "no results in Expenses table<br>";
 ...
 $SQLstring = "SELECT a.ExpNo,  a.ExpDesc, a.SerialNo, a.SupCode, a.PurchDate,a.ProdCostExVAT, a.Notes,	a.CustNo , a.Category,a.InvNo, 'expensesH' as Source
  FROM expensesH a  Where CustNo = $CustInt  order by ExpNo desc";
...
if ($rowCHk == '')
echo "no results in ExpensesH table<br>";




 $SQLstring = "SELECT a.ExpNo,  a.ExpDesc, a.SerialNo, a.SupCode, a.PurchDate,a.ProdCostExVAT, a.Notes,	a.CustNo , a.Category,a.InvNo, 'expensesE' as Source
  FROM expensesE a  Where CustNo = $CustInt  order by ExpNo desc";
 $SQLstring = "SELECT ExpNo,  ExpDesc, SerialNo, SupCode, PurchDate, ProdCostExVAT, Notes,	CustNo , Category, InvNo, 'expensesE' as Source
  FROM expensesE Where CustNo = $CustInt  order by ExpNo desc";
...
if ($rowCHk == '')
echo "no results in ExpensesE table<br>";
