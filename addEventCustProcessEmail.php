...
//	if(lengthRestriction(EDate, 10, 10)){
	if(notEmpty(EDate, "Please enter a long date and time")){
	if(notEmpty(ENotes, "Please enter a note")){
...
?>
<form name="add_event" onsubmit="return formValidator()" action="addEventProcessLastEmail.php" method="post">
...
//echo "<th>CustNo</th>";
echo "<th>EDate<br> DD Mon YYYY HH:MM AM<br>
05 June 2013 03:18 PM</th>";
