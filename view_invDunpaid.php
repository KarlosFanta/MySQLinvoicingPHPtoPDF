<?php
include "view_Unpaid_inv.php";
	
	//require_once("inc_OnlineStoreDB.php");
			
?>
<b><br><font size = "4" type="arial">View unpaid Invoices ALL CUSTOMERS</b></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;view_inv.php
</br>
...
AND  invoice.InvNo NOT IN  ( SELECT InvNoH  FROM transaction ) order by invoice.InvDate desc ";
//echo $SQLstring."<br><br>"; //the whole content of the table is now require_onced in a PHP array with the name $QueryResult.
//$QueryResult = @mysql_query($SQLstring, $DBConnect);

$SQLstring = "select invoice.InvNo, invoice.InvDate, invoice.TotAmt from invoice, transaction where invoice.InvNo NOT IN transaction.InvNoA order by invoice.InvDate desc";

$SQLstring = "select * from invoice where invoice.InvNo NOT IN ( SELECT InvNoA  FROM transaction ) AND invoice.InvNo NOT IN ( SELECT InvNoB  FROM transaction )  order by invoice.InvDate desc";
