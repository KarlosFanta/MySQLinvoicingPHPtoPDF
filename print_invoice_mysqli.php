...
?>
	<TITLE>Karl's Computers TAX Invoice No <?php echo $InvNo2; echo " ".$rowI['Summary']?> '12 prepaid ADSL</TITLE>
	<meta charset="UTF-8">
...
<TABLE WIDTH=100% BORDER=0 CELLPADDING=2 CELLSPACING=0>
	...
	<TR>
		<TH WIDTH=57%>
			<P LANG="en-GB" ALIGN=LEFT><FONT FACE="Arial, sans-serif"><FONT SIZE=4>KARL</FONT></FONT></P>
		</TH>
		<TH WIDTH=7%>
...
<COL WIDTH=90%>	<COL WIDTH=*>
		...
		<TH ><label>";
			...
			$rowI["Q4"]*$rowI["ex4"]+$rowI["Q5"]*$rowI["ex5"]+$rowI["Q6"]*$rowI["ex6"]+
			$rowI["Q7"]*$rowI["ex7"]+$rowI["Q8"]*$rowI["ex8"])*1.15),2);
...
Banking details: <br />
 ...
 Bank: Nedbank (/Nedcor)<br />
 Account Number: 1230583114<br />
 Branch No: 123009 or 12300900  (or 198765 or 19876500)<br />
 Branch: Go Banking (South Western Cape)<br />
