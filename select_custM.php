...
<form name="f1" action="select_CustProcessM.php" method="post">
...
?>
<select name="drop" onload="this.size=70;" onchange='this.form.submit()'>
<?php
	if (@$_SESSION['CustNo'] == "")  //works if session was destroyed
echo "<option value='_no_selection_'>Select Customer</option>";
else
...
?>
<select name="drop2" onload="this.size=70;" onchange='this.form.submit()' >
<?php
	if (@$_SESSION['CustNo'] == "")  //works if session was destroyed
echo "<option value='_no_selection_'>Select Customer</option>";
else
