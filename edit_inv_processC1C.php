...
?>
<b><font size = "4" type="arial">Edit the invoice's Details</b></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;edit_inv_processC1.php
...
-->
<form name="EditInv" action="edit_inv_processCHANGE.php" method="post">

<select name="mydropdownEC" onchange='this.form.submit()'>

<option value="_no_selection_">Select invoice where invoice number needs to be changed</option>";

<?php
$query = "select InvNo, CustNo, InvDate, Summary, TotAmt from invoice where CustNo = $CustInt ORDER BY Invno desc";
echo $query;
