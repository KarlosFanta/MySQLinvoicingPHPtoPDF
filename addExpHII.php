...
<form name="AddExp"  onsubmit="return formValidator()"  action="addExpHMultiII.php"   method="post">
<!--<form onsubmit='return formValidator()'  action="addTransprocessLast2.php"   method="post">-->

<br>
<a href = 'addExpH.php'>Click here to add multiple invoices with single dates</a>
<br>
...
<!--		<th>
<?php //include 'invJQueryExp.php'; //SELECT SupCode FROM suppliers
 ...
 ?>	
	<input id="SupCode"  name="SupCode" size="6" class='clSC' >
		...
		<th></b>Categories: Cyb, SARSpayments, Home, Eskom, Tel, private, Food, Bankfees, CellC, Groceries
</th>
	...
	<?php $CCC= $CustNo.",".$CustLN.$CustFN; ?>
	 <?php echo $CCC; ?>&nbsp;&nbsp;&nbsp;(business301)(300stock)<!--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
		...
		?>
			...
			<input id='lst'  size="10" name="PurchDateA" required >
		</th>

		<th>

			<!--	<input id="SupCode"  name="SupCode" size="6" class='clSC' >-->
		<input id="SupCodeA"  name="SupCodeA" required size="6" >
		...
		<th>
            ...
            title="This should be a number with up to 2 decimal places." name="Ain"  /><!--in VAT-->
		...
		<th>
				<?php echo ++$daNextNo;?>
				<input id='lst'  size="10" name="PurchDateB"  >
		</th>
		<th>

			<!--	<input id="SupCode"  name="SupCode" size="6" class='clSC' >-->
		<input id="SupCodeB"  name="SupCodeB" size="6" >
		</th>
		<th>
...
?>
	...
	<tr></tr>
		<th>
				<?php echo ++$daNextNo;?>
				<input id='lst'  size="10" name="PurchDateC"  >
		</th>
		<th>

			<!--	<input id="SupCode"  name="SupCode" size="6" class='clSC' >-->
		<input id="SupCodeC"  name="SupCodeC" size="6" >
		</th>
		...
		<tr></tr>
				<th>
				<?php echo ++$daNextNo;?>
				<input id='lst'  size="10" name="PurchDateD"  >
		</th>
		<th>

			<!--	<input id="SupCode"  name="SupCode" size="6" class='clSC' >-->
		<input id="SupCodeD"  name="SupCodeD" size="6" >
		</th>
	...
	<tr></tr>
		<th>
				<?php echo ++$daNextNo;?>
				<input id='lst'  size="10" name="PurchDateE"  >
		</th>
		<th>

			<!--	<input id="SupCode"  name="SupCode" size="6" class='clSC' >-->
		<input id="SupCodeE"  name="SupCodeE" size="6" >
</th>
		<th>
	...
	<th>
				<?php echo ++$daNextNo;?>
				<input id='lst'  size="10" name="PurchDateF"  >
		</th>
		<th>

			<!--	<input id="SupCode"  name="SupCode" size="6" class='clSC' >-->
		<input id="SupCodeF"  name="SupCodeF" size="6" >
</th>
	...
	<tr></tr>
		<th>
				<?php echo ++$daNextNo;?>
				<input id='lst'  size="10" name="PurchDateG"  >
		</th>
		<th>

			<!--	<input id="SupCode"  name="SupCode" size="6" class='clSC' >-->
		<input id="SupCodeG"  name="SupCodeG" size="6" >
</th>
	...
	<tr></tr>
		<th>
				<?php echo ++$daNextNo;?>
				<input id='lst'  size="10" name="PurchDateH"  >
		</th>
		<th>

			<!--	<input id="SupCode"  name="SupCode" size="6" class='clSC' >-->
		<input id="SupCodeH"  name="SupCodeH" size="6" >
</th>
