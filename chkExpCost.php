...
echo "HH $HH";
if (isset($_POST['BB'])) {
      echo "Bb button pressed";
} else if (isset($_POST['HH'])) {
       echo "HH button pressed";
} else {
   echo "no button pressed";
   $queryCatE = "SELECT * FROM expensesE where ProdCostExVAT between $AexM and $AexP";
echo "queryCatE: $queryCatE <br>";
		echo "<font size = 3 color = red> EXPENSES E similar date and similar price:</font><br>";
		//echo "<br><font size = 3 color = red>WARNING These are on same date:</font><br>";
if ($result = mysqli_query($DBConnect, $queryCatE)) {
...
echo "</table><br>";
   ...
   $queryCatE = "SELECT * FROM expensesE order by ExpNo Desc Limit 70";
echo "queryCatE: $queryCatE <br>";
		echo "<br><font size = 3 color = red> EXPENSES E similar date and similar price:</font><br>";
		//echo "<br><font size = 3 color = red>WARNING These are on same date:</font><br>";
if ($result = mysqli_query($DBConnect, $queryCatE)) {
echo "<table width='10' border='1'>\n";
echo "<tr><th>ExpNo</th>";
...
$queryCat = "SELECT * FROM expensesH where  ProdCostExVAT between $AexM and $AexP";
...
echo "</table>";
	...
	$queryCat = "SELECT * FROM expenses where ProdCostExVAT between $AexM and $AexP";
echo "queryCat: $queryCat <br>";
		//echo "<br><font size = 3 color = red>WARNING These are on same date:</font><br>";
...
$queryCat = "SELECT * FROM expensesE where ProdCostExVAT between $AexM and $AexP";
echo "queryCat: $queryCat <br>";
		echo "<br><font size = 3 color = red>WARNING These are on similar date and similar price:</font><br>";
		//echo "<br><font size = 3 color = red>WARNING These are on same date:</font><br>";
if ($result = mysqli_query($DBConnect, $queryCat)) {
...
<?php include 'invJQueryExp.php';
 ...
 ?>	
		...
		<th></b>Categories: Groceries, Eskom, Tel, 
</th>
