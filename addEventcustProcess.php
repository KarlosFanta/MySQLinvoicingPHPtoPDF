...
addEventCustProcess.php    calls addEventprocess_last2.php<br><br>
...
<th>
	...
	<!--<input type="text" name="cust_name" id="cust_fn" value="<?php //echo $daNextNo; ?>" />-->
	<input type="text"  size="10" id="Destination"  name="Destination" value="<?php  ?>_ " />
</th>
...
<th>
			...
			<!--<input type="text" name="cust_name" id="cust_fn" value="<?php //echo $daNextNo; ?>" />-->
	<input type="text"  size="100" id="ENotes"  name="ENotes" value="<?php echo date('g.i a', time()) ?>: " />
		</th>
...
Customer:
<?php
$queryS = "select CustNo, CustFN, CustLN from customer where CustNo = $CustInt";
//echo $queryS."<br>";
...
echo $item2b;
 ...
 echo "____".$CustInt; //selected customer of current session
 print "_".$item1b;
//echo "kjbjkbkjb";
print "_".$item3b;
