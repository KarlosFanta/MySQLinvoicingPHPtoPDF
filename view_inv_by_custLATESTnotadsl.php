...
<?php 
$SQLstring = "select * from invoice where CustNo = '$CustInt' and summary not like '%dsl' and summary not like '%web' order by InvNo desc";
$SQLstring = "select * from invoice where CustNo = '$CustInt' and summary not like '%dsl'  and summary not like '%web' order by InvNo desc";
if (@$un == 'N')
echo "Error - please try view_inv_by_custUNRECONCILED.php";
$un = 'Y';
echo "<br><br>Your Invoices History view_inv_by_custLATESTnotadsl.php";
?>
...
{
echo "ExpNo".$rowE['ExpNo'].": ".$rowE['ExpDesc']." ".$rowE['SerialNo']." ".$rowE['ProdCostExVAT']."<br>";
}
