...
?>
<b><br><font size = "4" type="arial">DELETE Customer's events</b></font>
</br>
</br>

<form name="Delcust" action="delEventCustProcessC.php" method="post">


<input type='hidden' name='CustNo' value="999999999">
...
echo "<option value='*'>Select all customers</option>";
