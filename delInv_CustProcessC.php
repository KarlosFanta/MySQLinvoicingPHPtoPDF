...
?>
<form name="delInv_process" action="delInv_CustProcessC2.php" method="post">
...
<b><font size = "4" type="arial">Delete <?php echo $item3 ?>'s invoices</b></font>
</br>
</br>

<select name="mydropdownEC" onchange='this.form.submit()'>

<option value="_no_selection_">Select invoice to be deleted</option>";
...
//$mysqli->close();
?>
<input type="submit" name="btn_submit" value="Delete selected invoice" /> 
