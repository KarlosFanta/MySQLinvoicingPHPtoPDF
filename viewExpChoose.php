...
?>
<b><br><font size = "4" type="arial">View Expenses</b></font>&nbsp;&nbsp;&nbsp;&nbsp;viewExpChoose.php
</br>
...
<form onsubmit='return formValidator()'  id="sectionForm"  action="assignExpChosen.php?CustNo=<?php echo $CustInt; ?>"   method="post">
Choose expenses for customer <input type="submit" value="Submit chosen expenses"> 
...
echo "<input type='checkbox' name='formDoor[]'  value='$ExpNo, $ExpDesc, $SupCode, $PurchDate, $ProdCostExVAT, $Notes, $Serial, $InvNo, $CustNo'>";
if ($InvNo == "")
echo "<font color = '#CC350C'>";
if ($CustNo == 300)
echo "<font color = 'orange'>ora";

echo "$ExpNo <input type='submit' value='submit'> </th><th>"; //0
...
$SerialNo = chunk_split($row['SerialNo'], 17, '<br>');
