...
$SQLstringTR = "select * from transaction  order by TransDate limit 14"; 
$SQLstringTR = "select * from (select * from transaction order by TransDate desc limit 14) Var1  order by TransDate limit 14";
...
//echo "<th>".$row["Var1"]."</th>";//CustNo is case senSitiVe
