...
?>
<form name="add_event" onsubmit="return formValidator()" action="addEventprocess_lastMAIN.php" method="post">
<font size = 3><b>Add event/Work In Progress/Unconfirmed Order for Customer <br></b></font>
addEventCustProcess_sess.php    calls addEventprocess_last2.php<br><br>

<a href= "addEventCustProcess_sessT.php">Click here to add for topups or ADSL events</a><br>
<a href= "addEventCustProcessADSL.php">Click here to add for other events any customer</a><br>
<a href= "addEventCustProcessEmail.php">Click here to add for EMAIL events any customer</a><br>
<?php
...
?>
	...
	<input type="text" size="10" id="EDate"  name="EDate" value="<?php echo $NewFormat; echo "201";?>" /> 
</th>
...
<th>
	...
	<!--<input type="text" name="cust_name" id="cust_fn" value="<?php //echo $daNextNo; ?>" />-->
	<input type="text"  size="50" id="ENotes"  name="ENotes" value="<?php echo date('g.i a', time()) ?>: in my office:" />
</th>
...
<br>
or: <br>
Select customer first:<br>
<form name="f2" action="addEventprocessCfirst.php" method="post">
<select name="mydropdownEC" >
...
<br><br>
<input type="submit" value="Select customer for event"  /> 
<br><br>
