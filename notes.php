...
<br>
   ...
   <form name="daBigNote">
	...
	$queryS = "SELECT * FROM comment2 ORDER BY id DESC LIMIT 1";
...
$rowsE = substr_count( $item1b, "\n" )+2; 	
	...
	<a href = 'phpmyadmin/index.php?db=kc&table=comment2' target = '_blank'>phpMyadmin</a> 
	...
	<div id="info" /> <!-- ajax happens in process22.php -->
   </form>
  </body>
</html>
