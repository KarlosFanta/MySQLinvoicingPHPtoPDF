...
$ProfitNo = $daNextNo+1;
*/
	echo "<font size = 4><a href= 'edit_hprofit.php'>EDIT PROFITS TABLE</a>";
...
if ($Amt == '')
{
echo "<font size = 6 color = red>error Amount on wrong spot correct in bank sheet</font><br>";
$Amt=$array[2];
}	

//echo "array0: ".$array[0]."<br>";
//echo "array1: ".$array[1]."<br>";
//echo "array2: ".$array[2]."<br>";
//echo "array3: ".@$array[3]."<br>";
//echo "array4: ".@$array[4]."<br>";
...
?>
<p id="p1"><?php echo "Pr".$ProfitNo; ?></p>
