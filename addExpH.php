...
<form name= "quick"  action="addExpHQ.php"   method="post">
Quick: CSVpaste: <input type='text'  style="width:326px"  name='csv' id='csv' size='5' >
	  <input type='submit' value="Create H expense"   style="width:200px;height:30px" /> 

</form>
Categories: <?php include 'viewCatExpH.php'; ?>

<form name="AddExp" onsubmit="return formValidator()" action="addExpHMulti.php"   method="post">
<!--<form onsubmit='return formValidator()'  action="addTransprocessLast2.php"   method="post">-->

<br>
<a href = 'addExpHII.php'>Click here to add multiple invoices with different dates</a><br>
<a href = 'addExpHtype.php?item=IceCreamCone&InVAT=5.50&Category=food&SupCode=MD'>MacD CONE</a>
<a href = 'addExpHtype.php?item=IceCreamCone&InVAT=6.90&Category=food&SupCode=ST'>Steers CONE</a> 
<a href = 'addExpHtype.php?item=IceCreamCone&InVAT=5.90&Category=food&SupCode=KFC'>KFC CONE</a> 
<a href = 'addExpHtype.php?item=ChocolateNestleAeroBarOne40g&InVAT=12.99&Category=food&SupCode='>Chocolate</a> 

<a href = 'addExpHtype.php?item=ElectricityEskomTaxExempt&InVAT=1000&Category=electricity&SupCode=EK'>ESKOM</a> 
<a href = 'addExpHtype.php?item=&InVAT=&Category=food&SupCode=Ch'>food</a> 
<a href = 'addExpHtype.php?item=&InVAT=&Category=food&SupCode=Ch&BCategory=food&BC=0'>foodx2</a> 
<a href = 'addExpHtype.php?item=&InVAT=&Category=food&SupCode=Ch&BCategory=food&BC=0&CCategory=food&CC=0'>foodx3</a> 
<a href = 'addExpHtype.php?item=&InVAT=&Category=food&SupCode=Ch&BCategory=food&BC=0&CCategory=food&CC=0&DCategory=food&DC=0'>foodx4</a> 
<a href = 'addExpHtype.php?item=&InVAT=&Category=food&SupCode=Ch&BCategory=food&BC=0&CCategory=food&CC=0&DCategory=food&DC=0&ECategory=food&EC=0'>foodx5</a> 
<a href = 'addExpHtype.php?item=&InVAT=&Category=food&SupCode=Ch&BCategory=food&BC=0&CCategory=food&CC=0&DCategory=food&DC=0&ECategory=food&EC=0&FCategory=food&FC=0'>foodx6</a> 
<a href = 'addExpHtype.php?item=&InVAT=&Category=food&SupCode=Ch&BCategory=food&BC=0&CCategory=food&CC=0&DCategory=food&DC=0&ECategory=food&EC=0&FCategory=food&FC=0&GCategory=food&GC=0'>foodx7</a> 
<a href = 'addExpHtype.php?item=&InVAT=&Category=food&SupCode=Ch&BCategory=food&BC=0&CCategory=food&CC=0&DCategory=food&DC=0&ECategory=food&EC=0&FCategory=food&FC=0&GCategory=food&GC=0&HCategory=food&HC=0'>foodx8</a><br>

<a href = 'addExpHtype.php?item=&InVAT=&Category=private&SupCode=Ch'>private</a> 
<a href = 'addExpHtype.php?item=&InVAT=&Category=private&SupCode=Ch&BCategory=private&BC=0'>privatex2</a> 
<a href = 'addExpHtype.php?item=&InVAT=&Category=private&SupCode=Ch&BCategory=private&BC=0&CCategory=private&CC=0'>privatex3</a> 
<a href = 'addExpHtype.php?item=&InVAT=&Category=private&SupCode=Ch&BCategory=private&BC=0&CCategory=private&CC=0&DCategory=private&DC=0'>privatex4</a> 
<a href = 'addExpHtype.php?item=&InVAT=&Category=private&SupCode=Ch&BCategory=private&BC=0&CCategory=private&CC=0&DCategory=private&DC=0&ECategory=private&EC=0'>privatex5</a> 
<a href = 'addExpHtype.php?item=&InVAT=&Category=private&SupCode=Ch&BCategory=private&BC=0&CCategory=private&CC=0&DCategory=private&DC=0&ECategory=private&EC=0&FCategory=private&FC=0'>privatex6</a> 
<a href = 'addExpHtype.php?item=&InVAT=&Category=private&SupCode=Ch&BCategory=private&BC=0&CCategory=private&CC=0&DCategory=private&DC=0&ECategory=private&EC=0&FCategory=private&FC=0&GCategory=private&GC=0'>privatex7</a> 
<a href = 'addExpHtype.php?item=&InVAT=&Category=private&SupCode=Ch&BCategory=private&BC=0&CCategory=private&CC=0&DCategory=private&DC=0&ECategory=private&EC=0&FCategory=private&FC=0&GCategory=private&GC=0&HCategory=private&HC=0'>privatex8</a> 


<br>$BCategory = @$_GET['Category'];

Please put in products or expensesH of 1 invoice:
...
<?php include 'invJQueryExp.php';
 ...
 ?>	
		...
		<th></b>Categories: Cyb, SARSpayments, Home, Groceries, Eskom, Tel, BankFees, CellC, Food, Private 
</th>
	...
	<?php $CCC= $CustNo.",".$CustLN.$CustFN; ?>
	 ...
	 <?php echo $CCC; ?>&nbsp;&nbsp;&nbsp;(business301)(300stock)<!--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
		...
		<th>
<?php 		echo $daNextNo;?>
			<input type="text"  size="53" id="ItemA" required name="ItemA"  /> <!--item Description-->
		</th>
...
<input type="text"  size="5" id="Ain" type="number" pattern="[0-9]+([\.|,][0-9]+)?" step="[0.01]+[0]" title="This should be a number with up to 2 decimal places." name="Ain"  value="<?php //echo $daNextNo;?>" /><!--in VAT-->
</th>
		...
		<th>
			<input type="text"  size="6" id="AK"  name="AK" required  value="<?php echo $Category; ?>" pattern="[A-Za-z0-9]+" /><!--Category-->
		</th>
...
<a href= "viewExpH.php" target=_blank>viewExpH.php</a>;
