...
<body>
<h3>Edit All High Priority events</h3><a href = "add_eventC.php">add_eventC</a> <a href = "view_events_destination.php">print</a> change Destination to _ and Priority to Done! when job is done.
<?php
/*
...
// Sorting field(s)   //i guess similar to orderby order by
$opts['sort_field'] = array('CustNo');  //CHANGE THIS VALUE!!
...
//$opts['filters'] = 'CustNo = "13"';
//$opts['filters'] = 'CustNo = $yo';
//$opts['filters'] = 'CustNo = $yo';
//$opts['filters'] = "Priority = 'High'";
$opts['filters'] = "Destination != '_'";
//$opts['filters'] = "Destination != ''  || '_'";
...
$opts['fdd']['CustNo'] = array(        //Unknown column 'PMEtable0.col_name' in 'on clause'
  ...
  'values'   => array(
    ...
    'description'=> array(
 //      'columns' => array('0' => 'CustNo', '1' => 'Abbr'),
  //     'divs'    => array('0' => '  ', '1' => '  '),
       'columns' => array_slice(array('0' => 'CustFN', '1' => 'Abbr'), 0,4),
      'divs'    => array('0' => '  ', '1' => '  '),
 //      'columns' => array('0' => 'Abbr'),
  //     'divs'    => array('0' => ' '),
     ),
     'orderby'=>'CustLN'
   )
...
$opts['fdd']['Priority'] = array(   //keep this here for editing purposes
  'name'     => 'Priority',
  'select'   => 'T',
  'maxlen'   => 300,
  'sort'     => true
