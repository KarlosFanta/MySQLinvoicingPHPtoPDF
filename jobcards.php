...
include 'justCustDetails.php';
	$queryS = "SELECT * FROM jobcards where CustNo = $CustNo ORDER BY id DESC LIMIT 1";
echo 	$queryS;
...
$rowsE = substr_count( $item1b, "\n" )+2;
   ...
   <form name="daBigNote">
	...
	<div id="info" /> <!-- ajax happens in process72jobcards.php -->
   </form>
  </body>
</html>
