<title>selectCustAssignStkInv</title>
<?php
...
<form name="Pro" action="assignStkInv.php" method="post">
<?php
...
$Prof = "Assign Stock to a Customer's Invoice";
if (@$_POST['btnSubmit'] != '')
...
<select name="CustNo"  onchange='this.form.submit()'>
