...
<form  action="addExpEMulti.php"   method="post">
ExpNo: <input type="text" size="6"  id="ExpNo"  name="ExpNo" value="<?php echo $daNextNo;?>" /><br>
SDR: <input type="text" id="ItemA" size = 34 name="ItemA" value="ULPpetrol L @<?php echo $arraySDR;?>"><!--ULPpetrol L @ -->
...
<br>
Category: <input type="text"  size="6" id="AK"  name="AK"  value="" required /><!--petrol-->
<input type="text"  size="5" id="AC"  name="AC" class='clCN'   value='0'  />(/300/301)<br>
SupCode: <input type="text"  id="SupCode"  name="SupCode" size="6" required  value='' ><br>
Notes: <input type="text"  id="AN"  name="AN" size="6"   value='' ><br>
	Serial/km: <input type="text"  id="AS"  name="AS" size="6"   value='' ><br>
...
$queryCat = "SELECT * FROM expensesE where (PurchDate  between '$dateM3' AND '$dateP3') and ProdCostExVAT between $AexM and $AexP";
echo "queryCat: $queryCat <br>";
...
$queryCat = "SELECT * FROM expensese where ExpDesc = '$arraySearch'";
