<html>
<head>
<title>Assign expense to invoice</title>
</head>
<body>
...
?>
<form  action="assignCustExptoInvLast.php"   method="post">

InvNo: <input type="text" id="InvNo"  name="InvNo" value="<?php echo $InvNo;?>">
...
echo $row['InvNo'];
echo '<br>';
echo 'Invoice Summary: '.$row['Summary'];
echo '<br>';
...
include "assignCustExpToInvGETtable.php";
echo "<br>";
echo "<input type='submit' value='submit selected' style='height:50px; width:200px'>";
$SQLstrX = "Select * from expenses where InvNo = '' ";
include "assignCustExpToInvGETtable.php";
...
<br><br><br>
Expenses already assigned to this Invoice:

<?php
$SQLstrX = "Select * from expenses where InvNo = '$InvNo' ";
echo "SQLstrX: ".$SQLstrX ;
...
$InvNor2 = $row['Notes'];
echo "<tr><th><font color = purple>$InvNor";
echo "</th>\n";
