...
$oout = array_slice($customers, 2);      // returns "c", "d", and "e"
//$stuff = array(1,2,3);
    print implode(", ", $oout);    //prints 1, 2, 3
	
    print join(',', $oout);    echo "<br><br>";
//print_r($customers);
echo "<br><br>";
//var_dump($customers);
...
?>
<input type="text" name="mde4" value="_nott_selection_" /> <br>
...
echo "<br><br>";
	...
	$query = "SELECT * FROM expenses WHERE category IN ( '$mde4' ,'$mde5' , '$mde6') order by CustNo";
