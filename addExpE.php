...
function formValidator(){
	...
	var ItemB = document.getElementById('ItemB');//Category
	var BC = document.getElementById('BC');//Category
...
//		if(notEmpty(Aex, "Please enter a valid numeric ex VAT")){
				...
				if(chk2ndCategoryNumberBC(ItemB,BC, "Please enter a category code in 2nd line")){
...
function chk2ndCategoryNumberBC(elem, elem2, helperMsg) {
...
Quick: CSVpaste: <input type='text'  style="width:326px"  name='csv' id='csv' size='5' required>
	  <input type='submit' value="Create E expense"   style="width:200px;height:30px" /> 

</form>
Categories: <?php include 'viewCatExpE.php'; ?>
...
<br><a href = 'addExpEtype.php?item=ULPpetrol L @&InVAT=&Category=petrol&SupCode=CT'>Click here to add petrol</a>
...
<?php include 'invJQueryExp.php';
 ...
 ?>	
		...
		<th></b><!--CategoriesE: <input size="60" value="<?php include 'viewCatExpE.php'; ?>">-->
...
<!--			<input type="text"  size="5" id="Aex" type="number" pattern="[0-9]+([\.|,][0-9]+)?" step="[0.01]+[0]"
		...
		<th>
			<input type="text"  size="6" id="AK"  name="AK"   value="<?php echo $Category; ?>" pattern="[A-Za-z0-9]+"/><!--Category-->
		</th>
