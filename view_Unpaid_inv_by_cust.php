...
$un = 'Y';
if ($un == 'Y')
echo "Your Unpaid Invoices History";
?>


 &nbsp;&nbsp;&nbsp;&nbsp;</font> </b>view_Unpaid_inv_by_cust.php &nbsp;&nbsp;&nbsp;<font color=#F5F5DC>order by InvNo desc</font>
...
echo "</b><br>";
//"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(Paid Invoices: R ".$PaidInvsummm."&nbsp;&nbsp;&nbsp;&nbsp;Unpaid Invoices: R ".$UnpaidInvsummm.")<br />";
