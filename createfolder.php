...
//if ($result = mysqli_query($DBConnect, $SQLstring)) {
 ...
 //while ($row = $result->fetch_row()) {
		...
		$newfldr = "1";
			//$newfldr = "file:///".$row['L1'] ;
			//$newfldr = "file://///F:/_work/Customers/A/AboutCars";
			//$newfldr = "file:///F:/_work/Customers/A/AboutCars";
			//$newfldr = "file:///F:/_work/Customers/A/AboutCars";
			//file:///F:/_work/Customers/A/AboutCars/AboutCars.txt
			//$newfldr = "file:///F|_work/Customers/A/AboutCars";
...
$FCLN = $Cust_LName[0];
		...
		echo "will be created in the follwoing folder:";
$L3 = "F:/_work/Customers/".$FCLN."";
echo $L3." <br>";
...
echo "</textarea>";
			...
			echo " <a href = 'http://www.karl.co.za/karllo0/reseller_interrogate.php?tel_number=$ADSLTel'  target=_blank>New Interrogate</a> ";
...
downloadNoise: below 6db is bad. (K: 21db) &nbsp;&nbsp;&nbsp;

uploadNoise: above 55 is bad(K: 12)<br>

downloadRes: below 6dB is bad. (K:17)&nbsp;&nbsp;&nbsp;

uploadRes: above 55dB is bad. (K: 34)<br>
<?php
echo "<br/> ";
...
<!--<a href= "file:///F:/_work/Customers/A/AboutCars">OPen folder</a> <br>-->
