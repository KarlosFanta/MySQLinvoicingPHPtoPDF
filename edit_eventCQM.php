...
if ($CustInt == 0)
$query = "select InvNo, CustNo, InvDate, Summary from invoice ORDER BY Invno";
else
{
$query = "select InvNo, CustNo, InvDate, Summary from invoice where CustNo = $CustInt ORDER BY Invno ";
...
require_once 'view_inv_by_cust.php';
