...
$sgs = 9398; //5598 changed to 5698  changed to 5798 when i got 5698 duplicate error and changed insert to 5764
...
<TH><input type='text' name='DD1' id='DD1' size='5' >
		...
		echo "<b><font size =2 color= dark orange align= left> {$row2['CustNo']}&nbsp; {$row2['CustLN']}&nbsp;<br>";
//echo "{$row2['CustLN']}&nbsp;&nbsp;&nbsp;";
		echo"<input id='D1' type='text' name='D1' size='53'  value='";

		//echo "".$b;
		//echo "First".$First;
		echo "'>"; //if nothing shows well then this customer does not have a D1 suggestion.
...
?>
	...
	<TR>
		...
		<TH><input type='text'  id='D3' name='D3' size='53'  value='<?php ?>'>Travel <?php echo $Distance; ?> km 
		</TH>
...
<br>
<input type='text' name='clExpC' id='clExpC' size  = '130' class='clExpC' value= 'Select a Product assigned to customer  class clExpC searchExpC.php if no result then customer has no expenses assigned'><br>
