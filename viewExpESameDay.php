...
//$SQLstring = "select * from expensesE where CustNo = $CustInt order by ExpNo  desc";
echo $PurchDate;
...
*/
$SQLstring = "select * from expensesE where PurchDate = '$PurchDate' or PurchDate = '$PD'   or PurchDate = '$PD2'  or PurchDate = '$PDp' or PurchDate = '$PDp2' order by PurchDate desc";
//$SQLstring = "select * from transaction  where TransNo >  (select Max(TransNo) from transaction) -88 order by TransDate";
//echo "&nbsp;&nbsp;&nbsp;&nbsp;All expensesE of 88 days ago:";
