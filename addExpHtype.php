...
$FC=@$_GET['FC'];
$GCategory=@$_GET['GCategory'];
$GC=@$_GET['GC'];
$HCategory=@$_GET['HCategory'];
$HC=@$_GET['HC'];

/*
echo "<br>addstk: " .$BCategory."</BR>";
echo "<br>addstk: " .$BC."</BR>";
echo "<br>addstk: " .$CCategory."</BR>";
echo "<br>addstk: " .$CC."</BR>";
echo "<br>addstk: " .$DCategory."</BR>";
echo "<br>addstk: " .$DC."</BR>";
echo "<br>addstk: " .$ECategory."</BR>";
echo "<br>addstk: " .$EC."</BR>";
echo "<br>addstk: " .$FCategory."</BR>";
echo "<br>addstk: " .$FC."</BR>";
echo "<br>addstk: " .$GCategory."</BR>";
echo "<br>addstk: " .$GC."</BR>";
echo "<br>addstk: " .$HCategory."</BR>";
echo "<br>addstk: " .$HC."</BR>";
*/
...
<a href = 'addExpQtype.php?item=&InVAT=&Category=&SupCode=Ch'>business</a> 
<a href = 'addExpQtype.php?item=&InVAT=&Category=&SupCode=Ch&BCategory=&BC=0'>businessx2</a> 
<a href = 'addExpQtype.php?item=&InVAT=&Category=&SupCode=Ch&BCategory=&BC=0&CCategory=&CC=0'>businessx3</a> 
<br>
...
<input type="hidden" id="CustNo"  name="CustNo" value="<?php echo $CustNo;?>";
		...
		<input id="SupCode"  name="SupCode" size="6" required  value='<?php echo $SupCode; ?>' >
...
<input type="text"  size="5" id="Ain" type="number" pattern="[0-9]+([\.|,][0-9]+)?" step="[0.01]+[0]" title="This should be a number with up to 2 decimal places." name="Ain"  value='<?php echo $InVAT; ?>'  /><!--in VAT-->
</th>
		...
		<th>
			<input type="text"  size="6" id="AK"  name="AK" required  pattern="[A-Za-z]+" value='<?php echo $Category; ?>' /><!--Category-->
		</th>

		</th>
			<th>
			<input type="text"  size="5" id="AC"  name="AC" class='clCN' required value='<?php echo '0'; ?>' /><!--Select a Customer-->
		</th>
		...
		<th>
			<input type="text"  size="6" id="BK"  name="BK"  value='<?php echo $BCategory; ?>'   /><!--Category-->
		</th>
	...
	<tr></tr>
		...
		<th>
			<input type="text"  size="6" id="CK"  name="CK"   value='<?php echo $CCategory; ?>'  /><!--Category-->
		</th>
		<th>
	...
	<?php echo ++$daNextNo;?>
		...
		<th>
			<input type="text"  size="6" id="DK"  name="DK"  value='<?php echo $DCategory; ?>'   /><!--Category-->
		</th>
			<th>
	...
	<tr></tr>
		...
		<th>
			<input type="text"  size="6" id="EK"  name="EK"   value='<?php echo $ECategory; ?>'  /><!--Category-->
		</th>
			<th>
...
<input type="text" size="51"  id="ItemF"  name="ItemF"  />
		...
		<th>
			<input type="text"  size="6" id="FK"  name="FK"   value='<?php echo $FCategory; ?>'  /><!--Category-->
		</th>
			<th>
	...
	<th>
		...
		<th>
			<input type="text"  size="6" id="GK"  name="GK"   value='<?php echo $GCategory; ?>'  /><!--Category-->
		</th>
			<th>
	...
	<tr></tr>
		<th>						<?php echo ++$daNextNo;?>
			...
			<input type="text" size="51"  id="ItemH"  name="ItemH"  />
	</th>
			<th>
	...
	<th>
		...
		<th>
			<input type="text"  size="6" id="HK"  name="HK"   value='<?php echo $HCategory; ?>'  /><!--Category-->
		</th>
			<th>
