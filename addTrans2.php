...
?>
<b><br><font size = "4" type="arial">Add Customer's Transactions</b></font>
</br>
</br>

<form name="AddTransCust" action="addTransCustProcess2.php" method="post">

<!--<select name="mydropdownEC" onchange="alert(this.options[this.selectedIndex].value)">>-->
<!--<select name="mydropdownEC" onchange="ChooseContact(this)">-->
