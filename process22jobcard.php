...
//$message = mysql_real_escape_string($message);
 ...
 $q1= "SELECT MAX(id) as max FROM jobcards2 LIMIT1";
...
*/
   ...
   $q12= "SELECT message FROM jobcards2 where id = $largestNumber";
// echo "q1:".$q1." ____<br>";
...
$qq= "INSERT INTO jobcards2(id,message) values('$largestNumber','$message')";
...
{ 
 echo "Your jobcards2 has been sent<br>";
	echo $qq;
  }
  else{
    echo "Error in sending your jobcards2";
	 echo $qq;
  }
  */
  }
  ...
  include "viewJobcards.php";
 // require_once "viewJobcards.php";
  /* $qq= "INSERT INTO jobcards2(id,message) values('$largestNumber','$message')";
...
printf("Online insert: %d\n", mysqli_affected_rows($Rlink));
 ...
 /* 
  $query = "SELECT * FROM jobcards2 ORDER BY id DESC LIMIT 1";
//  $query = "SELECT * FROM jobcards2 ORDER BY id = MAX(id)";
	//Execute query
