...
require_once ('inc_OnlineStoreDB.php');//mysqli connection and database selection
?>
<!DOCTYPE html>
<html>
<head>
...
<a href = 'createfolder.php'>Click here to create a folder</b></a></font><br><br><br><br><br><br><br><br>";
...
$invD3db = $row['invD3'];
$invD3db = utf8_decode($invD3db);
echo "invD3db: ".$invD3db."<br>";

//$invD3db =  strtr($row['invD3'], array(' ' => '&nbsp;')) ;
	$invD3db = str_replace("Â ","&nbsp;", $invD3db);  
	$invD3db = str_replace("Â ","a", $invD3db);  
	$invD3db = str_replace("Ã¤","&auml;", $invD3db);  
str_replace("\xc2\xa0",' ',$invD3db);
//echo "<input type='text' size = 35  name='invD3disable' value=";
...
echo "<textarea style='white-space:pre-wrap;font-family:arial;height:22px;width:300px;font-size: 10pt' name='invD3' >";
echo $row['invD3'];
echo "</textarea>";
...
echo "<input type='text' size = 35   name='invD5' id='invD5' value=";
...
<!--<a href= "file:///F:/_work/Customers/A/Abel_Jutta">OPen folder</a> <br>-->
