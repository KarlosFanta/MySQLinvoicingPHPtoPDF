...
<a href = 'createfolder.php' target='_blank' target='_blank'>Click here to create a folder</b></a></font><br><br><br><br><br><br><br><br>"; //target blank is Very important
...
<?php
echo" <a href = 'paynotes.php?CustNo=$CustInt' target='_blank'>Edit PayNotes only</a>";
...
echo "<textarea id='cust_fn' style='white-space:pre-wrap;font-family:arial;height:22px;width:220px;font-size: 10pt' name='CustFName' >";
echo $row['CustFN'];
echo "</textarea>";
...
//echo "<a href = 'view_inv_by_cust2.php?CustNo=$CustInt'>Click here to view customer's invoices (2) </a><br><br>";
echo "<b> <a href = 'edit_invCQ.php?CustNo=$CustInt' target=_blank>INV</a> ";
echo "<a href = 'editExpCQ.php?CustNo=$CustInt' target=_blank>EXP</a> </b>";
...
echo "<textarea id='CustLName' style='white-space:pre-wrap;font-family:arial;height:22px;width:220px;font-size: 10pt' name='CustLName' >";
echo $row['CustLN'];
echo "</textarea>";
echo "<head><title>";
echo $row['ABBR'];
...
$pwd = $CustPW;
//$word = "#";
//echo "<br>pwwwww:".$CustPW."<<<<br>";

//str_replace($CustPW,"#","hash");

$CustPW2 = preg_replace('/[#]/', 'hash', $CustPW);
//$new = htmlspecialchars($CustPW);
//echo "sp: ".$new. "sp ";
//echo "<br>pwwww2w:".$CustPW."<<<<br>";

/*	 if(strpos($CustPW, $word) !== false){
    echo "Word Found!";
} else{
    echo "Word Not Found!";
}

if (preg_match('/[#]/', $CustPW))
{
  echo "Word Found!";
} else{
    echo "Word Not Found!";
...
echo "<a href = 'view_inv_by_cust.php?CustNo=$CustInt' target='_blank'>customer's invoices</a>";
echo " <a href = 'view_trans_by_cust.php?CustNo=$CustInt' target='_blank'>tr</a>";
echo " <a href = 'edit_transCQ.php?CustNo=$CustInt' target='_blank'>tr</a>";
...
echo "<br>
DO NOT USE EXTRA AND CONFID BOXES! <br>
COpy all over to CustDetails text area<br>

<br> ";echo "<textarea id='Extra' style='white-space:pre-wrap; font-family:arial;width:500px;font-size: 7pt' rows= '6' size = '90' name='Extra' >";
...
$indesc = 0;
$ShowDraft = "N";
include "view_Unpaid_inv_by_cust2.php"; // UNpaid not UNDERpaid
echo "<br><br>";
...
include "view_Underpaid_inv_by_cust2b.php"; //2b is the one with checkboxes  UNDERpaid not UNpaid
...
echo "<br><a href= 'view_inv_by_custADVtopup.php' target='_blank'>Right-Click here to view topup invoices</a><br>";
...
echo "<a href = 'view_inv_by_custADVnoTransOVerPaidUnderPaid.php?CustNo=$CustInt'  target='_blank'>Click here to view all invoices with their transactions.</a><br><br>";
echo "<a href = 'view_inv_PAIDinvoicesBOTH.php?CustNo=$CustInt'  target='_blank'>Click here to view only PAID invoices </a><br><br>";
echo "<a href = 'view_inv_by_cust.php?CustNo=$CustInt' target='_blank'>Click here to view customer's invoices </a><br><br>";
echo "<a href = 'view_inv_by_cust2.php?CustNo=$CustInt' target='_blank'>Click here to view customer's invoices (2) </a><br><br>";
echo "<a href = 'edit_invCQ.php?CustNo=$CustInt'  target='_blank'>QuickEdit customer's  invoices(3) </a><br><br>";
echo "<a href = 'editExpCQ.php?CustNo=$CustInt'  target='_blank'>Click here to view customer's EXPENSES </a><br><br>";
//$indesc = 'd1';
echo "<a href = 'edit_trans_CustProcess.php?CustNo=$CustInt' target='_blank'>Click here to view STATEMENT </a>";
...
echo "<a href = 'viewEventcust.php?CustNo=$CustInt' target='_blank'>CustomersEvents</a><br><br>";
