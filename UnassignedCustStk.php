...
<a href = 'AssignedCustStk.php'>AssignedCustStk</a></br>
...
$SQLstring = "select * from expenses where InvNo = '' and CustNo != '300' and CustNo != '301' and CustNo != '0' order by ExpNo  desc";
