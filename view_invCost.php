	<title>All invoices all customers</title>
<?php
...
//$SQLstring = "select * from invoice where summary like '%norton%'  order by InvNo desc ";
...
echo substr($row2[0], 0, 19)." ";

echo substr($row2[1], 0, 19)."</th>";
